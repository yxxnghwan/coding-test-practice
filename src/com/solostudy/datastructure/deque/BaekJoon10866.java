...
public class BaekJoon10866 {
    ...
    private static void executeCommand(final String command) {
        if (command.startsWith("push_front")) {
            final Integer pushNumber = Integer.valueOf(command.split(" ")[1]);
            deque.addFirst(pushNumber);
        } else if (command.startsWith("push_back")) {
            final Integer pushNumber = Integer.valueOf(command.split(" ")[1]);
            deque.addLast(pushNumber);
            ...
            if (deque.isEmpty()) {
                ...
                final Integer number = deque.getFirst();
                System.out.println(number);
            }
            ...
            if (deque.isEmpty()) {
                ...
                final Integer number = deque.getLast();
                System.out.println(number);
            }
        }
    }
